...
// Provider is the implementation of `auth.Provider` for accessing AWS Cognito.
...
func (p *Provider) Debug(debug bool) {
	if debug {
		fmt.Println("WARNING: Debug request for auth/providers/cognito but no debug is available")
	}
}
