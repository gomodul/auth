...
// This package can be used as a reference impleentation of an OAuth provider for Auth.
package lastfm
...
// Provider is the implementation of `auth.Provider` for accessing LastFM
