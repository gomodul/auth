...
const (
	...
	// ScopeAnalyticsReadGames provides access to view analytics data for the
...
// Provider is the implementation of `auth.Provider` for accessing Twitch
...
func userFromReader(r io.Reader, user *auth.User) error {
	...
	user.RawData["location"] = "No location is provided by the Twitch API"
	user.AvatarURL = u.AvatarURL
	user.RawData["description"] = u.Description
	user.UserID = u.ID
