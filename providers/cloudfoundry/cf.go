...
// Provider is the implementation of `auth.Provider` for accessing Cloud Foundry.
...
func (p *Provider) RefreshToken(refreshToken string) (*oauth2.Token, error) {
	...
	ctx := context.WithValue(auth.ContextForClient(p.Client()), oauth2.HTTPClient, auth.HTTPClientWithFallBack(p.Client()))
