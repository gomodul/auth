...
// Provider is the implementation of `auth.Provider` for accessing Bitbucket.
...
func (p *Provider) getUserInfo(user *auth.User, sess *Session) error {
...
func (p *Provider) getEmail(user *auth.User, sess *Session) error {
